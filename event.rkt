...
(module+ test-suite
  (define-test-suite check-timeout-evt
...
(module+ test-suite
  (define-test-suite check-timer-evt
...
(module+ test-suite
  (define-test-suite check-poll-evt
  ...
  (define/provide-test-suite event-tests
    check-timeout-evt 
    check-timer-evt 
    check-poll-evt ))
